 <div class="sidebar" data-active-color="blue" data-background-color="white" data-image="{{ asset('masterpro/img/sidebar-1.jpg')}}">
        <!--
...
-->
    <div class="sidebar-wrapper">
        <div class="user">
            <div class="photo">
                <img src="{{ asset('masterpro/img/faces/marc.jpg')}}" />
            </div>
            <div class="info">
        ...
        <ul class="nav">
            <li class="active">
                <a href="#" class="nav-link btn-just-icon">
                    <small><i class="material-icons">dashboard</i> Panel</small>
                </a>
            </li>
            <li>
